...
ScheduleDetailView::ScheduleDetailView(const Schedule& schedule, ScheduleManager* manager, QWidget* parent)
    : QDialog(parent), m_schedule(schedule), m_scheduleManager(manager)
{
    setupUI();
    updateUI();
